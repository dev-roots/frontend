...
export const Header = () => {
  ...
  return (
    <>
      ...
      >
        <div className="items-center gap-x-14 px-5 mx-auto md:flex">
                ...
                return (
                  <li key={idx}>
                    ...
                    drapdownState.isActive ? (
                      <div className="mt-6 z-10 bg-white inset-x-0 top-20 w-full md:absolute md:border-y md:shadow-md md:mt-0">
              ...
              <div className="flex-1 items-center justify-end gap-x-6 space-y-3 md:flex md:space-y-0">
                {authenticated ? (
                  <>
                    ...
                    <li>
                      <button
                        title="Log out of the page"
                        onClick={handleLogout}
                        className="flex items-center justify-center gap-x-1 py-2 px-4 text-main-color font-medium yellow-gradient hover:bg-opacity-80 rounded-md md:inline-flex"
                      >
                        Log out
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
